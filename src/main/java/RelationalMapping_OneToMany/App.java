...
public class App {
  public static void main(String[] args) {
	...
	Employee e1= new Employee(101,"Sonal",4000000);
	Laptop l1 =new  Laptop(110158, "Windows" ,"HP", e1);
	Laptop l2 =new  Laptop(110157, "MacOs" ,"Apple", e1);
    ...
    Employee obj = session.get(Employee.class, 101);
